                ...
                <div>
                    ...
                    {this.state.filtro &&
                        <>
                            <Row>
                                <Col span={8}>
                                    <span style={{ 'margin-right': '30px' }}>Ano:</span>
                                    <Select
                                        name="year"
                                ...
                                <Col span={8}>
                                    <span style={{ 'margin-right': '30px' }}>Nês:</span>
                                    <Select
                                        name="month"
                                        defaultValue="Selecione"
                                        size="md"
                            ...
                            <Row>
                                <Col span={12}>
                                    <span style={{ 'margin-right': '30px' }}>Banco:</span>
                                    <Select
                                        name="bank_id"
                                ...
                                <Col span={12}>
                                    <span style={{ 'margin-right': '30px' }}>Categoria:</span>
                                    <Select
                                        name="category_id"
                            ...
                            <Row>
                                <Col span={12}>
                                    <span style={{ 'margin-right': '30px' }}>Descrição:</span>
                                    <Input
                    ...
                    <Row>
                        <Title level={4}>
                            Transações
                            <Link style={{ 'paddingLeft': '10px' }} to="/transaction">
                                <PlusCircleOutlined />
                            </Link>
                        </Title>
                        <Col span={24}>
